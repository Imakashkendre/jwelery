      ...
      {props.type && props.type === "select" ? (
        ...
        <>
          ...
          <input
            ...
            min={props.min}
            max={props.max}
            style={props.error ? { border: "1px solid red", background: "#fde6e6" } : {}}
          ></input>
          {
            props.showTextLength ? props.showTextLength : null
          }
        </>
      )}
    </>
...
const InputWithData = (props) => {
  return (
    <>
      ...
      <div className="main-cintainer-in-input-section-asfictus"
        style={props.error ? { border: "1px solid red", background: "#fde6e6" } : {}}
      >
        ...
        <input
          ...
          min={props.min}
          max={props.max}
          style={props.error ? { border: "1px  #fde6e6", background: "#fde6e6" } : {}}
